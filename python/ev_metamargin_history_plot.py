...
campaign_start = campaign_day(datetime.date(2016, 5, 22)) # is this right?
...
title("History of the Meta-Margin, 2016", fontsize=18,
		fontweight='bold')
ylabel("Clinton-Trump Popular Meta-Margin (%)",fontsize=16)
...
#
pfile = open("EV_prediction_MM.csv")
prediction = {}
