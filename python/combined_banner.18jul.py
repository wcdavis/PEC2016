...
def main(mm_infile, prob_infile, sen_infile, outfile):
    ...
    outfile.write(('\t<li><a href="/faq/">Snapshot (%s state polls)</a>:&nbsp;' +
            '<span style="color:blue">Clinton %s EV</span>,&nbsp;' +
    ...
    outfile.write('\t<li style="clear: both; padding-top: 0px; padding-left: 60px; color: black">Clinton Nov. win probability: random drift %s%%, <a href="/2012/09/29/the-short-term-presidential-predictor/">Bayesian %s%%</a></li>\n' % (drift_win_prob, bayesian_win_prob))

    outfile.write('\t<li style="padding-top: 0px; color: black">Senate snapshot:&nbsp;')
    ...
    outfile.write('<a href="/faq/#metamargin">Meta-margin: %s</a></li>\n' % sen_metamargin_str)
