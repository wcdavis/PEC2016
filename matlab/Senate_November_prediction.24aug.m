...
systematic=5; % Guess at systematic error this year. In principle, larger in off-years.
...
%
% Senate 2016: invoke as [predictmean,drift,bayes]=Bayesian_November_prediction(daystoelection,current_mm,5,1,1.9,6.8)
...
[predicted_mm,drift,bayes]=Bayesian_November_prediction(h,current_mm,5,1,1.9,6.8)
