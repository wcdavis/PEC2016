function [predictmean,drift_winprob,bayesian_winprob]=Bayesian_November_prediction(daystoelection,MM,maxdrift,mindrift,Prior2016,Prior2016SD)

MMdrift=min(0.4*sqrt(daystoelection),maxdrift);
