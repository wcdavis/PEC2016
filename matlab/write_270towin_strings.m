function [URL1 URL2 URL3]=write_270towin_strings(statep,Dprobs,Rprobs,path270);
% Generates URLs like http://www.270towin.com/maps/22201511116112122221111166262251111521012222651112211222
...
PEC_order='AL,AK,AZ,AR,CA,CO,CT,DC,DE,FL,GA,HI,ID,IL,IN,IA,KS,KY,LA,ME,MD,MA,MI,MN,MS,MO,MT,NE,NV,NH,NJ,NM,NY,NC,ND,OH,OK,OR,PA,RI,SC,SD,TN,TX,UT,VT,VA,WA,WV,WI,WY ';
towin_ord='AK AL AR AZ CA CO CT DC DE FL GA HI IA ID IL IN KS KY LA MA MD ME MI MN MO MS MT NC ND NE NH NJ NM NV NY OH OK OR PA RI SC SD TN TX UT VA VT WA WI WV WY ';
for iPEC=1:51
...
% write outputs
    ...
    fprintf(fid270,[str270 '\n'])
    fprintf(fid270,[str270_D '\n'])
    fprintf(fid270,[str270_R '\n'])
    fclose(fid270)
